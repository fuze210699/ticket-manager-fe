  ...
  <div class="bg-white rounded-lg shadow-sm p-4 h-full flex flex-col">
    ...
    <div v-if="!isMinimized" class="flex-1 flex flex-col">
          ...
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4">
                <button @click="togglePlay" class="text-white hover:text-gray-200">
                ...
                <button @click="toggleMute" class="text-white hover:text-gray-200">
      ...
      <div class="space-y-2">
        ...
        <p class="text-sm text-gray-500">{{ currentVideo?.description || 'Select a video to play' }}</p>
      </div>
    </div>
    ...
    <div v-if="showSettings" class="absolute top-0 left-0 right-0 bottom-0 bg-white p-4 rounded-lg shadow-lg">
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">{{ $t('common.quality') }}</label>
